...
45:     End With
46:
47:     '************Vytvori tabulku s predstaveniami*************
...
3:      Dim ODDELOVAC As String = StrDup(71, "─") '105
4:      Dim ODDELOVAC2 As String = StrDup(22, " ")
...
15:     Dim Vysledky(15) As Double
        Dim Odsadenie(15) As Integer
16:
17:     ODDELOVAC2 += StrDup((71 - Len(ODDELOVAC2)), "─")
18:
...
117:        PomocRetazec = ""
118:        For i = 3 To 6 ' 12
119:            If (Not i = 4 And Not i = 9) Then
...
157:                            If Len(Filmy(i3)) > 25 Then
158:                                PomocRetazec += LSet(Filmy(i3), 22) & "..."
159:                            Else
