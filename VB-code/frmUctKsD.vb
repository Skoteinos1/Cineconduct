...
24:     Vysledky(6) = CDbl(lblOdvodE.Text)
25:     Vysledky(7) = CDbl(lblOdvodPDH.Text)
26:     Vysledky(8) = CDbl(lblOdvod.Text)
27:
...
219:        PomocRetazec += StrDup((8 - Len(Format(CDbl(lblOdvodE.Text), "##0.00"))), " ") & Format(CDbl(lblOdvodE.Text), "##0.00")
220:        PomocRetazec += StrDup((Tab(10) - Len(PomocRetazec)), " ")
221:        PomocRetazec += StrDup((8 - Len(Format(CDbl(lblOdvodPDH.Text), "##0.00"))), " ") & Format(CDbl(lblOdvodPDH.Text), "##0.00")
222:        PomocRetazec += StrDup((Tab(11) - Len(PomocRetazec)), " ")
223:        PomocRetazec += StrDup((8 - Len(Format(CDbl(lblOdvod.Text), "##0.00"))), " ") & Format(CDbl(lblOdvod.Text), "##0.00")
...
195:                .Position = i
196:                If .Current("datum") = CDate(DataGridView1.Rows(i2).Cells(1).Value & "." & Year(DatumDO)) And Format(CDate(.Current("cas")), "HH:mm") = DataGridView1.Rows(i2).Cells(2).Value Then
...
217:                    Odvod = (CDbl(.Rows(i).Cells(3).Value) - CDbl(.Rows(i).Cells(5).Value)) / (1 + (frmSpracovavanie.pDPH / 100))
...
268:    lblOdvodE.Text = Format(OdvodE, "##0.00")
269:    lblOdvodPDH.Text = Format(OdvodDPH, "##0.00")
270:    lblOdvod.Text = Format(Odvod, "##0.00")
271:
...
Chyba:
    ...
    Private Sub frmUctKBD_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
51:         .Columns.Add("dtgrdSala", "Trzba -DPH")
...
66:
67:
68:         .ResumeLayout(True)
69:     End With
70:
71:     'Naplni combobox z distributormi
72:     With frmSpracovavanie.DistributoriBindingSource
73:         cmbDistributori.Items.Clear()
74:         .MoveFirst()
75:         For i = 1 To .Count
76:             cmbDistributori.Items.Add(.Current("Distributor"))
77:             .MoveNext()
78:         Next i
79:     End With
80:
81:     lblTrzba.Text = 0
82:     lblNavstev.Text = 0
83:     lblStrn.Text = 0
84:     lblStrnNav.Text = 0
85:     lblNakl.Text = 0
86:     lblOdvod.Text = 0
87:     lblOdvodE.Text = 0
88:     lblOdvodPDH.Text = 0
89:     lblpDPH.Text = "Sadzba DPH: " & frmSpracovavanie.pDPH & "%"
